...
.method public static synthetic k(Ljava/util/stream/LongStream;)Lj$/util/stream/k0;
    .locals 1
...
.method public final synthetic a()Lj$/util/stream/k0;
    ...
    .line 0
    iget-object v1, p0, Lj$/util/stream/i0;->a:Ljava/util/stream/LongStream;
    ...
    invoke-static {v0}, Lj$/util/stream/i0;->k(Ljava/util/stream/LongStream;)Lj$/util/stream/k0;
...
.method public final synthetic asDoubleStream()Lj$/util/stream/B;
    ...
    invoke-static {v0}, Lj$/util/stream/z;->k(Ljava/util/stream/DoubleStream;)Lj$/util/stream/B;
...
.method public final synthetic average()Lj$/util/z;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->B(Ljava/util/OptionalDouble;)Lj$/util/z;
...
.method public final b(Lj$/time/format/r;)Lj$/util/stream/k0;
    ...
    invoke-static {p1}, Lj$/util/stream/i0;->k(Ljava/util/stream/LongStream;)Lj$/util/stream/k0;
...
.method public final synthetic boxed()Lj$/util/stream/Stream;
    ...
    invoke-static {v0}, Lj$/util/stream/X2;->k(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic c()Lj$/util/stream/k0;
    .locals 2
...
.method public final synthetic d()Lj$/util/stream/k0;
    .locals 2
...
.method public final synthetic e()Lj$/util/stream/k0;
    .locals 2
...
.method public final synthetic findAny()Lj$/util/B;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->D(Ljava/util/OptionalLong;)Lj$/util/B;
...
.method public final synthetic mapToObj(Ljava/util/function/LongFunction;)Lj$/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/X2;->k(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic onClose(Ljava/lang/Runnable;)Lj$/util/stream/g;
    ...
    invoke-static {p1}, Lj$/util/stream/e;->k(Ljava/util/stream/BaseStream;)Lj$/util/stream/g;
...
.method public final synthetic parallel()Lj$/util/stream/g;
    ...
    invoke-static {v0}, Lj$/util/stream/e;->k(Ljava/util/stream/BaseStream;)Lj$/util/stream/g;
...
.method public final synthetic peek(Ljava/util/function/LongConsumer;)Lj$/util/stream/k0;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/B;
    ...
    invoke-static {p1}, Lj$/com/android/tools/r8/a;->D(Ljava/util/OptionalLong;)Lj$/util/B;
